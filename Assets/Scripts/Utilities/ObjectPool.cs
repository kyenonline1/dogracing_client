...
namespace Utilites.ObjectPool { 
    public sealed class ObjectPool : MonoBehaviour
    {
        ...
        public static StartupPool GetStartupPool(string prefabname)
        {
            var sp = instance.startupPools.Where((s) => s.name.Equals(prefabname));
            return sp.FirstOrDefault();
        }
        public static void CreateStartupPools()
        {
            //Debug.Log("CreateStartupPools: " + instance.startupPoolsCreated);
        ...
        {
            //Debug.Log("CreatePool: " + prefab.name);
        ...
        {
            GameObject prefab;
            //Debug.LogError("Recycle: " + obj.name);
        ...
        public static void RecycleAll(GameObject prefab)
        {
            ...
            {
                //Debug.LogError("prefab : " + prefab.name + " , Item: " + item.Value.name + " , Check: " + (item.Value == prefab));
                if (item.Value == prefab)
                    tempList.Add(item.Key);
            }
            //Debug.LogError("RecycleAll; " + tempList.Count);

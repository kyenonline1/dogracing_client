    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.Double ||
                ...
                Type json_type;
                if (inst_type == typeof(long) && (reader.Value is long || reader.Value is int))json_type = typeof(long);
                else json_type = reader.Value.GetType();
                                        ...
                                        int depth)
        {
            ...
            if (obj is IDictionary) {
                UnityEngine.Debug.LogError("DICT");
                writer.WriteObjectStart ();

                UnityEngine.Debug.LogError("START DICT");

                foreach (DictionaryEntry entry in (IDictionary) obj) {
                    UnityEngine.Debug.LogError("START DICT"+ entry);
